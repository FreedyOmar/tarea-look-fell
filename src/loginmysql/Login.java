...
public class Login extends javax.swing.JFrame {
    ...
    public Connection Conectar() {
        Connection con = null;
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost/login","OMAR","PEPITO");
    ...
    public void ingresar() {
        ...
        if (User.equals("") || Pass.equals("")) {
            ...
            try {
                con1 = Conectar();
                pst = con1.prepareStatement("select USERNAME, PASSWORD from login where username='" + User
                        + "' and PASSWORD ='" + Pass + "'");
                rs = pst.executeQuery();
                if (rs.next()) {
                    this.dispose();
    ...
    private void initComponents() {
        ...
        getContentPane().add(PanelPrincipal, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, -1, 400));
